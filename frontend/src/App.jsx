    ...
    <div className="app">
      ...
      <aside className={`sidebar${sidebarOpen ? ' open' : ''}`}>
        <div className="sidebar-brand">
          ...
          <button className="sidebar-close" onClick={() => setSidebarOpen(false)} aria-label="Закрыть">
      ...
      <main className="main">
        {/* Mobile topbar — visible only on mobile, for non-chat views */}
        {view !== 'chat' && (
          <div className="mobile-topbar">
            ...
            <span className="mobile-topbar-title">
              {view === 'docs' ? 'База знаний' : view === 'numsearch' ? 'Цифровой поиск' : 'Граф связей'}
            </span>
          </div>
        )}
